...
public class DatePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int curtainColor = a.getColor(R.styleable.DatePicker_wheelCurtainColor, Color.TRANSPARENT);
    ...
    public void setDateViewVisible(boolean year, boolean month, boolean day) {
